...
class Icarus_Module_FanfouItems
{
            ...
            <div class="card">
                <div class="card-content comment-container">
                    <div class="field is-grouped">
                        <div class="control">
                            <h3 class="title is-5 has-text-weight-normal"><?php _IcTp('general.message'); ?></h3>
                        </div>
                    ...
                    <?php if ($widget->allow('comment')): ?>
                        <div id="<?php $widget->respondId(); ?>" class="respond">
                            <form method="post" action="<?php $widget->commentUrl() ?>" id="comment-form" role="form">
                                <div class="field is-grouped">
                                    <div class="control">
                                        <h3 id="response" class="title is-5 has-text-weight-normal"><?php _IcTp('comments.do_comment_title'); ?></h3>
                                    </div>
        ...
        <div class="media-content" id="<?php $comments->theId(); ?>">
            <div class="content">
                <div class="comment-header">
                    <span class="comment-author"><?php Icarus_Module_FanfouItems::printCommentAuthor($comments); ?></span>
